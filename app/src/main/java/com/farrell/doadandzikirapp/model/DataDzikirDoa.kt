...
object DataDzikirDoa {
    ...
    val listDzikir: ArrayList<DzikirDoaModel>
        get() {
            val list = arrayListOf<DzikirDoaModel>()
    ...
    val listDzikirPagi: ArrayList<DzikirDoaModel>
        get() {
            val list = arrayListOf<DzikirDoaModel>()
            for (data in descDzikirPagi.indices) {
                val dzikirDoa = DzikirDoaModel(
                    descDzikirPagi[data],
    ...
    val listDzikirPetang: ArrayList<DzikirDoaModel>
        get() {
            val list = arrayListOf<DzikirDoaModel>()
