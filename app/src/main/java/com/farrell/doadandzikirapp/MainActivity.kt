...
import com.farrell.doadandzikirapp.adapter.ArtikelAdapter
import com.farrell.doadandzikirapp.databinding.ActivityMainBinding
import com.farrell.doadandzikirapp.model.ArtikelModel
import com.farrell.doadandzikirapp.ui.DzikirDanDoaActivity
import com.farrell.doadandzikirapp.ui.DzikirPagiDanPetangActivity
import com.farrell.doadandzikirapp.ui.DzikirSetiapSaatActivity
import com.farrell.doadandzikirapp.ui.ShunnahQouliyahActivity
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            R.id.ll_dzikir_doa_shalat -> {
                val intentDDS = Intent(this@MainActivity, ShunnahQouliyahActivity::class.java)
            ...
            R.id.ll_dzikir_doa_harian-> {
                val intentDDH = Intent(this@MainActivity,DzikirDanDoaActivity::class.java)
                startActivity(intentDDH)
            }

            R.id.ll_dzikir_pagi_petang-> {
                val intentPP = Intent(this@MainActivity,DzikirPagiDanPetangActivity::class.java)
